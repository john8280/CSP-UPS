...
BottomTabNavigationProp<TabStackParamList, 'Customers'>,NativeStackNavigationProp<RootStackParamList, 'MyModal'> >;
  ...
  return (
    <View>
      ...
      <View style={{ marginTop: 10 }}>
        <View style={[tailwind('py-5 border-b'), { color: "#59C1CC" }]}>
          <Text
